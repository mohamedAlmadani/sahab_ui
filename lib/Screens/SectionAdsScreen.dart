...
import 'package:sahab/Screens/AboutTheAppScreen.dart';
import 'package:sahab/Screens/CallUsScreen.dart';
import 'package:sahab/Screens/DetailsProductScreen.dart';
import 'package:sahab/Screens/MainScreenProduct.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        title: Text(' سيارات هافال',style: TextStyle(
